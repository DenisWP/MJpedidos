            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    if (nomeC.isEmpty()
                        ...
                        url = "http://192.168.0.104/mjpedidos/cadastrar.php?nome=" + nomeC + "&senha=" + senhaC + "&telefone=" + telefoneC + "&longradouro=" + endereçoC +
                                "&numero=" + numeroC + "&bairro=" + bairroC + "&cidade=" + cidadeC + "&cep=" + cepC + "&email" + emailC;


                        // NÃO ESTOU UTILIZANDO AINDA, SÓ PARA TESTE AFFFF.....
